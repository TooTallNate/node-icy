...
function Reader (metaint, opts) {
  ...
  debug('created new Reader instance with "metaint": %d', metaint);
}
...
Reader.prototype._onRawData = function (chunk, output) {
  output(chunk);
  if (this.left === 0) {
